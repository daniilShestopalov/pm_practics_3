...
3. **Разработана программа для распределения индивидуальных задач между участниками команды**  
   Программа распределяет задачи с учётом их оценочной сложности и предпочтения участников, которые определы в [документе](https://docs.google.com/spreadsheets/d/1cF5TRl7nrVsRsqArbRuitErmMEczpvvZUCg7Ef271B4/edit?gid=0#gid=0).
