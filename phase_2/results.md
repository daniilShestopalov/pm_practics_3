...
1. **Проведена декомпозиция проекта на 10 отдельных задач**  
   Подробный перечень задач содержится в файле: [Task decomposition for phase 3](/Task decomposition for phase 3)

2. **Выполнена оценка трудоёмкости каждой задачи**  
   Оценка выполнена в формате таблицы и находится в файле: [Оценка задач.xlsx](/Оценка задач.xlsx)
