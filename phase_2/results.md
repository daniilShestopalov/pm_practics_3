...
1. **Проведена декомпозиция проекта на 10 отдельных задач**  
   Подробный перечень задач содержится в файле: [Task decomposition for phase 3](/Task%20decomposition%20for%20phase%203)

2. **Выполнена оценка трудоёмкости каждой задачи**  
   Оценка выполнена в формате таблицы и находится в файле: [Оценка задач.xlsx](/Оценка%20задач.xlsx)
